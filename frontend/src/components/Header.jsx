...
import { Bell, LogOut, User as UserIcon, ChevronDown, History as HistoryIcon } from "lucide-react";
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={() => navigate("/app/history")} data-testid="header-menu-history">
                  <HistoryIcon className="mr-2 h-4 w-4" /> {t("common.history")}
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem
