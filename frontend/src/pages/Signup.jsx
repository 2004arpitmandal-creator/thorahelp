    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-slate-50">
      <div className="hidden lg:flex relative items-end overflow-hidden">
        ...
        <div className="relative z-10 p-12 text-white max-w-md">
          ...
          <h2 className="mt-6 font-display font-black text-4xl tracking-tighter leading-[1.05]">
            Join the neighborhood<br />safety net.
          </h2>
          <p className="mt-4 text-white/80 font-body">It&apos;s free. It takes 30 seconds. You may save a life.</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 lg:p-12">
        <Card className="w-full max-w-md p-8 border-slate-200 shadow-none">
          ...
          <h1 className="font-display font-black text-3xl text-slate-900 tracking-tight">Create your account</h1>
          <p className="mt-1.5 text-sm text-slate-500 font-body">Start helping your neighbors today.</p>
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              <Label htmlFor="name" className="font-body font-semibold text-slate-700">Full name</Label>
              <div className="relative mt-1.5">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                <Input
                  id="name" type="text" required minLength={1}
            ...
            {error && (
              <div data-testid="signup-error" className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2 font-body">
                {error}
              </div>
            )}
            ...
            <Button
              ...
              className="w-full h-11 font-display font-bold bg-red-600 hover:bg-red-700 text-white"
            >
          ...
          <p className="mt-6 text-sm text-center text-slate-500 font-body">
            Already a member?{" "}
            <Link to="/login" data-testid="signup-to-login-link" className="text-red-600 font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </Card>
